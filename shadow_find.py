...
"""
    ...
    def extract_links_from_page(self, url, depth):
        ...
        # Identity Profile Scrapers (Emails and Phone Data Lines)
    ...
    def display_results(self):
        ...
        print(f"  {Colors.GREEN}●{Colors.RESET} Phone Links Tracked:     {Colors.WHITE}{len(self.phone_numbers)}{Colors.RESET}")
        ...
        self._render_section("PHONE NUMBERS IDENTIFIED", self.phone_numbers, Colors.MAGENTA)
